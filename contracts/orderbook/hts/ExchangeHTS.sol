...
contract ExchangeHTS is OrderBookHTS, ReentrancyGuard {    
    ...
    constructor(address _tokenA, address _tokenB) {
        ...
        SafeHTS.safeAssociateToken(tokenA, address(this));
        SafeHTS.safeAssociateToken(tokenB, address(this));
    }
     ...
     */
    function placeBuyOrder(int64 price, int64 volume) public nonReentrant returns(uint256) {
     ...
     */
    function placeSellOrder(int64 price, int64 volume) public nonReentrant returns(uint256) {
        require(price > 0, "Invalid Price");
        require(volume > 0, "Invalid Volume");
     ...
     */
    function deposit(address token, int64 amount) public nonReentrant {
