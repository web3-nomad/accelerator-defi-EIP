...
interface IHederaTokenService {
    ...
    function getApproved(address token, int64 serialNumber) external returns (int64 responseCode, address approved);
    ...
    /// @return responseCode The response code for the status of the request. SUCCESS is 22.
    function wipeTokenAccount(address token, address account, uint32 amount) external returns (int64 responseCode);
